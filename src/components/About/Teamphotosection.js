...
export default function Teamphotosection() {
  ...
  <div class="card">
    <img src="https://images.pexels.com/photos/879109/pexels-photo-879109.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="card-img-top" alt="..."/>
    <div class="card-body">
      <h5 class="card-title">QAMAR MUKHTAR</h5>
      <p class="card-text">I love to coding and making apps website learning about coding and new technology from the world .</p>
